                        ...
                        {activeMainTab === 2 && (
                            <div>
                                ...
                                {activeSubTab === 3 && <div>
                                    <div class="grid place-items-center">
                                        <div class="lg:w-full md:w-full sm:w-full w-full justify-center mx-auto">
                                            <h3 className='text-3xl'>ICD-10 Books</h3>
                                            <div className="grid 2xl:grid-cols-6 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-3 grid-cols-3 space-x-1 mt-5">
                                                <button
                                                    className={`${activeTab === 'tab1' ? 'bg-blue-500' : 'bg-gray-200'
                                                        } px-0  py-2 my-2 rounded-lg text-md hover:text-white`}
                                ...
                                {activeSubTab === 4 && <div>
                                    <div class="grid place-items-center">
                                        <div class="lg:w-full md:w-full sm:w-full w-full justify-center mx-auto">
                                            <h3 className='text-3xl'>CPT® Books</h3>
                                            <div className="grid 2xl:grid-cols-6 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-3 grid-cols-3 space-x-1 mt-5">
                                                <button
                                                    className={`${activeTab === 'tab1' ? 'bg-blue-500' : 'bg-gray-200'
                                                        } px-0  py-2 my-2 rounded-lg text-md hover:text-white`}
                                ...
                                {activeSubTab === 5 && <div>
                                    <div class="grid place-items-center">
                                        <div class="lg:w-full md:w-full sm:w-full w-full justify-center mx-auto">
                                            <h3 className='text-3xl'>Medical Coding Book Bundles</h3>
                                            <div className="grid 2xl:grid-cols-6 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-3 grid-cols-3 space-x-1 mt-5">
                                                <button
                                                    className={`${activeTab === 'tab1' ? 'bg-blue-500' : 'bg-gray-200'
                                                        } px-0  py-2 my-2 rounded-lg text-md hover:text-white`}
                                ...
                                {activeSubTab === 7 && <div>
                                    <div class="grid place-items-center">
                                        <div class="lg:w-full md:w-full sm:w-full w-full justify-center mx-auto">
                                            <h3 className='text-3xl'>Reference Guides</h3>
                                            <div className="grid 2xl:grid-cols-6 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-3 grid-cols-3 space-x-1 mt-5">
                                                <button
                                                    className={`${activeTab === 'tab1' ? 'bg-blue-500' : 'bg-gray-200'
                                                        } px-0  py-2 my-2 rounded-lg text-md hover:text-white`}
