                        ...
                        <div>
                            {activeSubTab === 1 && <div>
                                <div className="sm:w-100 w-100 justify-center mx-auto">
                                    ...
                                    <h3 className='text-3xl my-3'>Upcoming Workshops</h3>
                                </div>
                                <div className="grid place-items-center mt-5">
                                    <div className="flex flex-row md:flex-row sm:w-full w-full justify-center">
                                        <div className="sm:w-1/4 w-1/4">
                                            <img src="./compliance.webp" alt='#'/>
                                        </div>
                                        <div className="sm:w-3/4 w-3/4">
                                            <div className="mb-5">
                                                <p className='font-semibold 2xl:text-xl lg:text-lg'>Compliance Essentials for Risk Adjustment: Navigating DOJ/OIG Activities</p>
                                                <h6 className="font-semibold lg:text-lg text-lightsky">NOVEMBER 30, 2023 | CEUs: 6.0 </h6>
                                                <p className="font-semibold mt-2"><del>$189.95</del> <span className="text-red-600">$149.95</span></p>
                                                <button className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-12 lg:text-md text-sm rounded mt-2">
                                                    LEARN MORE
                                                </button>
                                            </div>
                                        </div>
