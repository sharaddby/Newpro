  ...
  return (
    <div>
      <div className="grid place-items-center">
        <div className="2xl:w-8/12 xl:8/12 lg:8/12 w-11/12 justify-center mx-auto">
        ...
        <div className="flex flex-col md:flex-row 2xl:w-8/12 xl:w-8/12 lg:w-11/12 md:w-11/12 sm:w-11/12 w-11/12 justify-center gap-8 mb-5">
          ...
          <div className="2xl:basis-1/5 xl:basis-1/5 lg:basis-1/5 md:w-1/3 sm:w-1/3 w-full">
            <svg className="w-6 h-6 text-green-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21">
      ...
      <div className="grid place-items-center">
        <div className="2xl:w-8/12 xl:8/12 lg:8/12 w-full justify-center mx-auto">
          <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 w-100 bg-gray-100">
      ...
      <div className="grid place-items-center">
        <div className="2xl:w-8/12 xl:8/12 lg:8/12 w-11/12 justify-center mx-auto">
          <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 w-100">
      ...
      <div className="grid place-items-center">
        <div className="2xl:w-8/12 xl:8/12 lg:8/12 w-11/12 justify-center mx-auto">
          <div className="grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 w-100 my-5">
