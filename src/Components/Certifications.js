    ...
    return (
        <div>
            <div class="grid w-full bg-green-800 bg-cover bg-center" style={{ backgroundImage: 'url("../ris.webp")' }}>
                <div class="2xl:w-8/12 xl:w-8/12 lg:w-full md:w-full sm:w-full w-full justify-center mx-auto py-20">
            ...
            <div class="grid place-items-center mt-10">
                <div class="2xl:w-8/12 xl:w-11/12 lg:w-11/12 md:w-11/12 sm:w-11/12 justify-center mx-auto">
                    <div class="grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 justify-center mx-auto">
                        <Slider1/>
                    </div>
                </div>
            </div>
