        ...
        <div>
            <div className="grid w-full bg-green-800 bg-cover bg-center py-56" style={{ backgroundImage: 'url("../ris.webp")' }}>
                <div className="2xl:w-8/12 xl:w-8/12 lg:w-8/12 md:w-8/12 sm:w-8/12 w-8/12 justify-center mx-auto">
                    ...
                    <button className="px-12 py-3 my-5 rounded-full bg-gray-500">
                        <a href="https://tailwindui.com/documentation"
                            className="rounded-full text-xl text-white">LET'S TALK 
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-right" className="svg-inline--fa fa-angle-right fa-fw text-sm h-8 w-6 inline-block text-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
