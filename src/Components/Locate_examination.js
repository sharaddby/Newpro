            ...
            <h2 className='text-4xl my-3 font-semibold text-footsky'>Schedule Your Certification Exam</h2>
              <div class="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 w-100 gap-8">
                <div class="bg-slate-200 p-5">
                  <h3 class="text-3xl mb-5 font-semibold">Purchase Exam Vouchers</h3>
                  ...
                  <div className="mt-5">
                    <button class="py-3 mb-0 rounded-full">
                      <a
                        href="https://tailwindui.com/documentation"
                        class="rounded-full text-teal-900"
                ...
                <div class="bg-slate-200 p-5">
                  <h3 class="text-3xl mb-5 font-semibold">
