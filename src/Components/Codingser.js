        ...
        <div className="2xl:w-8/12 xl:w-8/12 lg:w-8/12 md:w-8/12 sm:w-8/12 mx-auto mt-20">
            ...
            <div> <img src="../age.webp" alt="#"/></div>
               <div>
                    ...
                    <p className="text-darksky text-lg font-semibold">GET THE ESSENTIALS</p>
                </div>
            </div>
        </div>
    </div>
    <div className="grid place-items-center mt-10 bg-darkble px-10 py-10">
        <div className="2xl:w-8/12 xl:w-8/12 lg:w-full md:w-full sm:w-full w-full justify-center mx-auto ">
            <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 w-100 gap-8">
                ...
                <div className="p-5">
                    <h1 className="text-3xl mb-5 text-white">Networking and Support</h1>
                    <p className="text-lg text-white">Exploring a career in medical coding and billing raises questions, one
                        being
                    ...
                    <button className="px-12 py-3 rounded-full">
                        <a href="https://tailwindui.com/documentation"
                            className="text-xl bg-teal-900 text-white px-5 py-2">Grow your skil </a>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div className="grid place-items-center mt-10">
            <div className="2xl:w-8/12 xl:w-8/12 lg:w-full md:w-full sm:w-full w-full justify-center mx-auto mt-10 mb-10">
                ...
                <div className="grid place-items-center bg-darkble h-72 mt-5">
                    <div className="pt-5">
