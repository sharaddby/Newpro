        ...
        <div>
            ...
            <div class="grid place-items-center mt-10">
                <div class="2xl:w-8/12 xl:w-8/12 lg:w-full md:w-full sm:w-full w-full justify-center mx-auto ">
                    <div class="sm:grid-cols-1 w-100">
                        <div>
                            <h3 class="text-3xl font-semibold">Invest in Your Team's Future: Equip Your Employees for Success </h3>
                            <p class="text-xl">Empower your employees with the tools and knowledge to succeed in their roles
                             as healthcare business professionals with AAPC Corporate Team Training. Our experts will evaluate 
                             your specific needs and provide training solutions that will equip your team with the skills to 
                             succeed in today's complex healthcare environment.​   </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="grid place-items-center mt-10">
                <div class="2xl:w-8/12 xl:w-8/12 lg:w-full md:w-full sm:w-full w-full justify-center mx-auto ">
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 w-100 gap-8">
                        <div>
                            <h3 class="text-3xl mb-5">Our Trainers</h3>
