    ...
    return (
        <div>
            <div className="grid place-items-center mt-10">
                <div className="2xl:w-8/12 xl:w-11/12 lg:w-11/12 md:w-11/12 sm:w-11/12 w-11/12 justify-center mx-auto my-20">
                    ...
                    <div className="mt-4">
                        {activeTab === 'tab1' && (
                            <div className="p-4 bg-white rounded-lg">
                                <div className="p-4 grid place-items-center mt-16">
                                    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:w-100 w-100 gap-4">
                                        <div className="bg-slate-100 pl-10 hover:shadow-2xl ">
                                            <img src="../certi8.webp" alt="..." />
                                            <p className='text-green-900'>CORE + CODING</p>
                                            <p className="text-xl">Certified Professional Coder (CPC)® + Certified Professional
                                                Biller (CPB)® dual certifications</p>
                                            <button className="py-3 rounded-full">
                                                <a href="./Certified_Professional_Coder"
                                                    className="rounded-full text-xl text-green-900 hover:footsky ">read more<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-right" className="svg-inline--fa fa-angle-right fa-fw text-sm h-5 w-6 inline-block text-green-800" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
                        ...
                        {activeTab === 'tab2' && (
                            <div className="p-4 bg-white">
                                <div className="grid place-items-center mt-16">
                                    <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 w-100 gap-4">
                                        <div className="bg-slate-100 pl-10 hover:shadow-2xl">
